...
export const HomeExpItems = [
    {title: "User Management System", src: ums, text:["React.js / Hooks / Redux", "Node.js / Express", "MongoDB Cloud", "Restful APIs"], github: "https://github.com/Viclin0127/express-user-management-system", demo: {isDemo: true, url: ""}},
